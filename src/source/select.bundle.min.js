	...
	return function () {
		...
		return n(t, [{
			...
			value: function (e) {
				...
				if (this._config.initValue)
					this._setValue(this._config.initValue, !0)
				else
					this._setValue(this._config.options[0].value, !0)
			}
		}, {
			...
			key: "_handleClick",
			value: function (e) {
				if (e.target.className !== this._config.classNames.autocompleteInput) {
					...
					if (this._state.opened) {
						...
						console.log('close');
						if (t != undefined && this._config.multiple) {


							if (this.value() && this.value().includes(t.get().getAttribute("data-value"))) {
								return t &&
									this._unselectOption(e)
							}
							return t &&
								this._setValue(t.get().getAttribute("data-value"), !0)
			...
			value: function (e, t, n) {
				...
				if (!(this._config.disabledOptions.indexOf(e) > -1)) {
					if (
						e &&
						!n && (this._config.value = this._config.multiple ? [].concat(a(this._config.value || []), [e]) : e),
			...
			value: function (e) {
				...
				this._options.forEach((function (n) {
					n.get().textContent.toLowerCase().includes(e.target.value.toLowerCase()) ? n.removeClass(t._config.classNames.optionHidden) : n.addClass(t._config.classNames.optionHidden)
				}))
			}
		}]), t
	}()
